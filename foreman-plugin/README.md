...
Under the hood it runs `npx foreman-kingdom`, which reads the projects Claude remembers, asks Claude Code to write each project's plaque, generates a three.js world, and serves it at http://localhost:5173.
